...
public class DashboardController {
    ...
    @GetMapping("/preview/{groupName}")
    public DashboardPreviewVO getDashboardPreview(@PathVariable String groupName) throws Exception {
        return dashboardService.getDashboardPreview(groupName);
    }
}
