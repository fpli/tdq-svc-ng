...
@Component("CJSAdsAlertTask")
@Lazy(false)
public class CJSAdsAlertTask {
    ...
    @SchedulerLock(name = "adsMetricAlert", lockAtLeastFor = "PT5M", lockAtMostFor = "PT30M")
    public void run() throws Exception {
        LocalDate dt = LocalDate.now(ZoneId.of("GMT-7")).minusDays(1);
        alertManager.cjsAdsMetricAbnormalDetection(dt);
    }
