...
public class SimpleExecutionEngine implements ExecutionEngine {
     ...
     *  3. get all metrics details from Pronto
     *  4. calculate scorecard for each domain
     *     - 4.1 covert rule definition to GroovyScriptRule BO
     *     - 4.2 parse metric values and set in rules
     *     - 4.3. execute groovy rule script to get score
